...
public class EverythingItemsHolderSet implements ICustomHolderSet<Item> {
    public static final MapCodec<EverythingItemsHolderSet> CODEC = MapCodec.unit(EverythingItemsHolderSet::new);

    private final List<Holder<Item>> holders;

    public EverythingItemsHolderSet() {
